  ...
  if (sessions.length === 0 || classes.length === 0) {
    return (
      <div className="mx-auto max-w-4xl p-6">
        <h1 className="mb-2 text-xl font-semibold text-gray-900 dark:text-gray-50">Timetable</h1>
        <p className="text-sm text-gray-500">Set up an academic session and at least one class first.</p>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-5xl p-6">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-50">Timetable</h1>
