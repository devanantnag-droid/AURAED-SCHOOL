...
export function ResetPasswordModal({ personName, onSubmit, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="max-h-[85vh] w-full max-w-sm overflow-y-auto rounded-md bg-white p-5 shadow-lg dark:bg-gray-900">
        <h2 className="mb-1 text-sm font-semibold text-gray-900 dark:text-gray-50">Reset password for {personName}</h2>
        <p className="mb-4 text-xs text-gray-500">
          This takes effect immediately — their old password stops working. Share the new one with them
          directly.
        </p>
        ...
        <div className="space-y-3">
          <div>
            ...
            <input type="text" className="input w-full" value={password} onChange={(e) => setPassword(e.target.value)} autoFocus />
          </div>
          <div>
